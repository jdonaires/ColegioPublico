...
CALL PROC_MODIFICAR_INSTITUCIONES (1,1487854,205,'Primaria','Fe y Alegria N°30','-','Escolarizado',154875,'-','-','-','','','AA.HH San Isidro','1489-GREJ','200245','-','Mixto','-','1','D009707',''); 
...
CALL PROC_BUSCAR_INSTITUCIONES(2);